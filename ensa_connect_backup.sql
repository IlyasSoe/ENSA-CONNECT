...
--
-- Host: localhost    Database: ensa_connect
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '0ac9600e-ba9d-11f0-8e9b-c64e3520009f:1-148';
...
CREATE TABLE `users` (
  ...
  `role_id` tinyint NOT NULL COMMENT '1:Etudiant , 2:Lauréat , 3:Mentor , 4:Admin',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dump completed on 2026-03-19  3:20:23
